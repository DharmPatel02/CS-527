-- ADD_MISSING_CATEGORY_COLUMN.sql
-- This script adds the missing category column to auction_items table
...
ADD COLUMN category item_category NOT NULL DEFAULT 'car';
