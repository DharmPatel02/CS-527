-- Fixed PostgreSQL Schema for Auction System (Supabase Compatible)
-- This schema matches the backend entity classes
...
SELECT 'Fixed schema created successfully with RLS enabled!' as status; 